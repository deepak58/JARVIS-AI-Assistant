...
import datetime
import subprocess
from app_control import close_application, close_all, shutdown_pc
...
def execute_command(command):
    ...
    # ---------- Date ----------
        ...
        # ---------- Close Applications ----------
    elif "calculator" in command and "close" in command:
        return close_application("calculator")

    elif "chrome" in command and "close" in command:
        return close_application("chrome")

    elif "paint" in command and "close" in command:
        return close_application("paint")
